#------------------------------------------------------------------------------#
# TODO Remove this file - Makefile is deprecated in favor of CMake+Ninja     #
# This makefile was generated by 'cbp2make' tool rev.147 for legacy builds    #
# Use: cmake -G Ninja .. && ninja (see README.md for details)                 #
#------------------------------------------------------------------------------#
