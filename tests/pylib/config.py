...
class TestConfig(SafeConfigParser):
    ...
    def write(self, fp, sort=False, space_around_delimiters=True):
        ...
        Please note that comments in the original configuration file are
        not preserved when writing the configuration back.
        """
        ...
        for section in self._sections:
            self._write_section(fp, section, self._sections[section].items(), d, sort)
