...
struct __attribute__((packed)) Dir {
  ...
  Coordinate asNormalizedCoord() const;  // (-1, -0, 1, -1, 0, 1)
...
// wraps like int16_t. Can be used, e.g., for a location in the simulator grid,
// or for the difference between two locations.
