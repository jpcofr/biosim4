#ifndef BIOSIM4_SRC_CORE_GENETICS_SENSORS_ACTIONS_H_
#define BIOSIM4_SRC_CORE_GENETICS_SENSORS_ACTIONS_H_
...
using Core::Genetics::ACTION_MAX;
using Core::Genetics::ACTION_MIN;
using Core::Genetics::ACTION_RANGE;
using Core::Genetics::NEURON_MAX;
using Core::Genetics::NEURON_MIN;
using Core::Genetics::NEURON_RANGE;
using Core::Genetics::Sensor;
using Core::Genetics::SENSOR_MAX;
using Core::Genetics::SENSOR_MIN;
using Core::Genetics::SENSOR_RANGE;
}  // namespace BioSim

#endif  ///< BIOSIM4_SRC_CORE_GENETICS_SENSORS_ACTIONS_H_
