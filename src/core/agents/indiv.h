#ifndef BIOSIM4_SRC_CORE_AGENTS_INDIV_H_
#define BIOSIM4_SRC_CORE_AGENTS_INDIV_H_
...
#include "../../core/genetics/genome-neurons.h"
...
#endif  ///< BIOSIM4_SRC_CORE_AGENTS_INDIV_H_
